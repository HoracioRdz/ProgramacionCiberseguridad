"""
Horacio Rodriguez Tellez - 1809071
virustotal_scan
~~~~~~~~~~~~~~~
...
#Intenta importar requests y si no puede se tiene que instalar
...
#Funcion principal donde tambien hace que pidan los parametros en la linea de comandos
...
if __name__ == '__main__':
    main()
#Es funciona dependiendo del funcionamiento que se le de al script, un ejemplo si se utiliza como funcion y no este este se ejecura si la importa a otro programa
